        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                           <button type="button" data-toggle="modal" data-target="#cari" class="btn bg-cyan waves-effect">Tambah Tarif</button>
                        ...
                        <div class="body table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tbody>
								<?php foreach($master_tarif as $v){ ?>
                                     <tr>
                                        <td><?php echo $v->vendor_name; ?></td>
                                        <td><?php echo $v->master_asal; ?></td>
                                        <td><?php echo $v->tujuan; ?></td>
                                        <td><?php echo $v->baseon_tarif; ?></td>
                                        <td><?php echo $v->harga_tarif; ?></td>
                                        <td>
										<div class="btn-group">
										...
										<ul class="dropdown-menu">
											<li><a href="<?php echo base_url("admin/edit_master_tarif/$v->id_tarif"); ?>" class=" waves-effect waves-block">Edit</a></li>
											<li><a href="<?php echo base_url("admin/hapus_master_tarif/$v->id_tarif"); ?>" class=" waves-effect waves-block">Hapus</a></li>
										</ul>
										</div>
										</td>
                                    </tr>
                          ...
                          <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                              ...
                              <!-- modal header -->
                                ...
                                <form role="form" action="<?php echo base_url('admin/tambah_master_tarif'); ?>" enctype="multipart/form-data" method="post">
								...
								<div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="harga_tarif" class="form-control" placeholder="-- HARGA --" REQUIRED>
                                        </div>
                                    </div>
                                </div>
                                </div>
