        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                           <button type="button" data-toggle="modal" data-target="#tambah" class="btn bg-cyan waves-effect">Tambah Vendor</button>
                        ...
                        <div class="body table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tbody>
								<?php foreach($master_vendor as $v) { ?>
                                     <tr>
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="<?php echo base_url("admin/edit_master_vendor/$v->vendor_id"); ?>" class=" waves-effect waves-block">Edit</a></li>
                                        <li><a href="<?php echo base_url("admin/hapus_master_vendor/$v->vendor_id"); ?>" class=" waves-effect waves-block" onclick="javascript : return confirm('Data Akan Di Hapus')">Hapus</a></li>
                                    </ul>
                                </div>
										</td>
                                    </tr>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <!-- modal header -->
                                ...
                                <form role="form" action="<?php echo base_url('admin/tambah_master_vendor'); ?>" enctype="multipart/form-data" method="post">
