...
<title>CETAK LAPORAN DELEVERY</title>
</head>
<body>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="25%"><img src="<?php echo base_url(); ?>/assets/images/jte.png" width="199" height="69" /></td>
    <td width="75%" align="center"><p>DATA LIST DLEVERY</p></td>
  </tr>
</table>
<HR/>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<?php foreach($cetak_laporan_delevery_header as $header) { ?>
  <tr>
    <td width="11%">Kode Delevery</td>
    <td width="39%">: <?php echo $header->kode_delevery; ?></td>
  </tr>
  <tr>
    <td>Pengemudi</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <?php $no=1; foreach($cetak_laporan_delevery as $v) { ?>
  <tr>
