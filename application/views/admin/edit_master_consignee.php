        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <a href="<?php echo base_url('admin/master_consignee'); ?>" type="button" class="btn bg-teal waves-effect"><i class="material-icons">reply</i> Kembali</a>
                            <ul class="header-dropdown m-r--5">
                                
                            </ul>
                        </div>
                        <div class="body">
						<?php foreach($edit_master_consignee as $v) { ?>
                            <form role="form" action="<?php echo base_url("admin/simpan_master_consignee/$v->consignee_id"); ?>" enctype="multipart/form-data" method="post">
                                <label>Shipper Code</label>
								<div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="consignee_code" class="form-control" value="<?php echo $v->consignee_code; ?>" REQUIRED>
                                        </div>
                                    </div>
									<label>Shipper Name</label>
								<div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="consignee_name" class="form-control" value="<?php echo $v->consignee_name; ?>" REQUIRED>
                                        </div>
                                    </div>
									<label>Alamat</label>
								<div class="form-group">
