        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                           <button type="button" data-toggle="modal" data-target="#tambah" class="btn bg-cyan waves-effect">Tambah Agen</button>
                        ...
                        <div class="body table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tbody>
								<?php foreach($master_agen as $v) { ?>
                                     <tr>
                                        <td><?php echo $v->agen_code; ?></td>
                                        <td><?php echo $v->agen_name; ?></td>
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="<?php echo base_url("admin/edit_master_agen/$v->id_agen"); ?>" class=" waves-effect waves-block">Edit</a></li>
                                        <li><a href="<?php echo base_url("admin/hapus_master_agen/$v->id_agen/$v->agen_code"); ?>" class=" waves-effect waves-block" onclick="javascript : return confirm('Data Akan Di Hapus')">Hapus</a></li>
                                    </ul>
                                </div>
										</td>
                                    </tr>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <!-- modal header -->
                                ...
                                <form role="form" action="<?php echo base_url('admin/tambah_master_agen'); ?>" enctype="multipart/form-data" method="post">
								<label>Agen Code</label>
								<div class="form-group">
                                        <div class="form-line focused warning">
                                            <input type="text" name="agen_code" class="form-control" placeholder="Agen Code" REQUIRED>
                                        </div>
                                    </div>
									<label>Agen Name</label>
								<div class="form-group">
                                        <div class="form-line focused warning">
                                            <input type="text" name="agen_name" class="form-control" placeholder="Agen Name" REQUIRED>
                                        </div>
                                    </div>
									<label>Alamat</label>
								<div class="form-group">
