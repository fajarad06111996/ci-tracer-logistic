        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <a href="<?php echo base_url('admin/master_agen'); ?>" type="button" class="btn bg-teal waves-effect"><i class="material-icons">reply</i> Kembali</a>
                            <ul class="header-dropdown m-r--5">
                                
                            </ul>
                        </div>
                        <div class="body">
						<?php foreach($edit_master_agen as $v) { ?>
                            <form role="form" action="<?php echo base_url("admin/simpan_master_agen/$v->id_agen"); ?>" enctype="multipart/form-data" method="post">
                                <label>Agen Code</label>
								<div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="agen_code" class="form-control" value="<?php echo $v->agen_code; ?>" REQUIRED>
                                        </div>
                                    </div>
									<label>Agen Name</label>
								<div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="agen_name" class="form-control" value="<?php echo $v->agen_name; ?>" REQUIRED>
                                        </div>
                                    </div>
									<label>Alamat</label>
								<div class="form-group">
