...
<body class="fp-page">
    <div class="fp-box">
        <div class="logo">
            <a href="javascript:void(0);"><b>TRACER LOGISTIC</b></a>
        ...
        <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <!-- <form class="form-horizontal" action="<?php// echo base_url("admin/cek_tarif_pengiriman"); ?>" method="post" target="_blank"> -->
                              <?php foreach($cek_tarif_pengiriman as $v) { ?>
								<div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="password_2">ASAL</label>
                                    </div>
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text"  class="form-control" value="<?php echo $v->master_asal; ?>" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
								<div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="password_2">TUJUAN</label>
                                    </div>
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="nama_pic"  class="form-control" value="<?php echo $v->tujuan; ?>" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
								<div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="nama_pic"  class="form-control" value="<?php echo $v->harga_satuan; ?>" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
							  ...
							  <div class="row m-t-20 m-b--5 align-center">
									<a href="<?PHP ECHO BASE_URL("admin/form_cek_tarif"); ?>">Kembali</a> 
								</div>
                               <!--  <div class="row clearfix">
                                    <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                                        <button type="submit" class="btn btn-primary m-t-15 waves-effect">Cek</button>
                                    </div>
                                </div>  -->
                            </form>
                        </div>
